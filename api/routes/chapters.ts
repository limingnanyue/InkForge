...
router.patch('/:id', (req: Request, res: Response) => {
  ...
  try {
    ...
    return fail(res, 'DB_ERROR', `更新章节失败：${(e as Error).message}`, 500);
  }
});
...
router.delete('/:id', (req: Request, res: Response) => {
  try {
    ...
    return fail(res, 'DB_ERROR', `删除章节失败：${(e as Error).message}`, 500);
  }
});
...
router.post('/:id/snapshot', (req: Request, res: Response) => {
  try {
    ...
    return fail(res, 'DB_ERROR', `创建快照失败：${(e as Error).message}`, 500);
  }
});
...
router.post('/:id/generate', (req: Request, res: Response) => {
  try {
    ...
    return fail(res, 'DB_ERROR', `派发生成任务失败：${(e as Error).message}`, 500);
  }
});
...
router.post('/:id/refine', (req: Request, res: Response) => {
  try {
    ...
    return fail(res, 'DB_ERROR', `派发精修任务失败：${(e as Error).message}`, 500);
  }
});
